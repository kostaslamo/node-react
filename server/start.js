...
if (process.env.NODE_ENV !== 'production' && !fs.existsSync(dotEnvFilePath)) fs.copyFileSync(`${__dirname}/../sample.env`, dotEnvFilePath);
if (process.env.NODE_ENV !== 'production' && fs.existsSync(dotEnvFilePath)) dotEnv.config({ path: dotEnvFilePath });
